                ...
                <div className="navbar-nav mx-auto text-center">
                  <div className="nav-item dropdown">
                    ...
                    <div className="dropdown-menu">
                      ...
                      <Link to="/life" className="dropdown-item">
                        Life Insurance
                      </Link>
                ...
                <div>
                  <div className="card rounded-4 border-0">
                    ...
                    <div className="card-body">
                      ...
                      <button style={{ border: '1px solid #003d2b', padding: '10px 0px' }} data-bs-target="#exampleModalToggle2" data-bs-toggle="modal" data-bs-dismiss="modal" className="btn btn-primary w-100 mb-3 verify-btn-clr">Sign in with OTP</button>
