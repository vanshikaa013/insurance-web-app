                  ...
                  <ul className="navbar-nav">
                    <li className="nav-item">
                      ...
                      >
                        Insurance Products{" "}
                        <span
                          className={`fa-solid ${activeDropdown === "insurance" ? "fa-minus" : "fa-plus"
                            }`}
                        ></span>
                      </a>
                      {activeDropdown === "insurance" && (
                        <ul className="submenu">
                          <li className="mobile-navbar-link-to-icon">
                            <Link to="/motor"  className="submenu-item" onClick={closeOffcanvas}>
                              Motor Insurance
                            </Link>
                            <i class="fa-solid fa-angle-right  mycolor"></i>
                          </li>
                          <li className="mobile-navbar-link-to-icon">
                            <Link to="/life"  className="submenu-item" onClick={closeOffcanvas}>
                              Life Insurance
                            </Link>
                            <i class="fa-solid fa-angle-right  mycolor"></i>
                          </li>
                          <li className="mobile-navbar-link-to-icon">
                            <Link to="/health"  className="submenu-item" onClick={closeOffcanvas}>
                              Health Insurance
                            </Link>
                            <i class="fa-solid fa-angle-right  mycolor"></i>
                          </li>
                          <li className="mobile-navbar-link-to-icon">
                            <Link to="/travel"  className="submenu-item" onClick={closeOffcanvas}>
                              Travel Insurance
                            </Link>
                            <i class="fa-solid fa-angle-right  mycolor"></i>
                          </li>
                    ...
                    <li className="nav-item">
                      ...
                      >
                        Renew Your Policy{" "}
                        <span
                          className={`fa-solid ${activeDropdown === "renewPolicy" ? "fa-minus" : "fa-plus"
                            }`}
                        ></span>
                      </a>
                      {activeDropdown === "renewPolicy" && (
                        <ul className="submenu">
                          <li className="mobile-navbar-link-to-icon">
                            <Link to='/motor' href="#"  className="submenu-item" onClick={closeOffcanvas}>
                              Motor Renewal
                            </Link>
                            <i class="fa-solid fa-angle-right  mycolor"></i>
                          </li>
                          <Link to='/life' className="mobile-navbar-link-to-icon" >
                            <a href="#"  className="submenu-item" onClick={closeOffcanvas}>
                              Life Policy Renewal
                            </a>
                            <i class="fa-solid fa-angle-right  mycolor"></i>
                          </Link>
                          <Link to='/health' className="mobile-navbar-link-to-icon">
                            <a href="#"  className="submenu-item" onClick={closeOffcanvas}>
                    ...
                    <li className="nav-item">
                      ...
                      >
                        Resources{" "}
                        <span
                          className={`fa-solid ${activeDropdown === "resources" ? "fa-minus" : "fa-plus"
                            }`}
                        ></span>
                      </a>
                      {activeDropdown === "resources" && (
                        <ul className="submenu">
                          <Link to='/' className="mobile-navbar-link-to-icon">
                            <a href="#"  className="submenu-item" onClick={closeOffcanvas}>
                              Blog
                            </a>
                            <i class="fa-solid fa-angle-right  mycolor"></i>
                ...
                <div>
                  <div className="card rounded-4 border-0">
                    ...
                    <div className="card-body">
                      ...
                      <button data-bs-target="#exampleModalToggle2media" style={{ border: '1px solid #003d2b' }} data-bs-toggle="modal" data-bs-dismiss="modal" className="btn btn-primary w-100 mb-3">Sign in with OTP</button>
                    <div className="or-divider text-center">
                        <span className='p-2 mb-3 orbitton'><hr /> <div>or</div> <hr /></span>
                    </div>
                    <button className="btn btn-success w-100 mb-3 loginformwhat" style={{color:'#28b53e'}}>
                        {/* <i className="fab fa-whatsapp me-2" />  */}
                        <div className="loginformwhat">
                        <img src="	https://static.pbcdn.in/myaccount-cdn/images/imagesv3/filled_whatsapp.svg" alt="" />
                         Sign in with WhatsApp
                        </div>
                    </button>
                    <button className="btn btn-light w-100 buttonloginwithgoogle">
